...
import './Navbar.css'
import logo from '../Assests/Screenshot_2024-03-09_234630-removebg-preview.png'
    ...
    return (
        <div className='navbar'>
            <div className="nav-logo">
               <a href="https://www.tejaswinisales.shop/"> <img src={logo} alt="" style={{padding: "-80px" , height: '150px'}} /></a>
            </div>
