    ...
    const handleProceedToPayment = async () => {
        if (checkLoginStatus()) {
          ...
          try {
            ...
            const response = await fetch('https://backend3-9t1m.onrender.com/orders', {
              method: 'POST',
              body: JSON.stringify({
                amount,
                currency,
            ...
            const options = {
              ...
              handler: function () {
                toast.success('Payment has done succefully')
                setTimeout(() => {
                ...
                if (cartItems[e.id] > 0) {
                    return <div>
                        <div className="Cartitems-format cartItems-format-main">
                            ...
                            <p>{e.name}</p>
                            <p><i class="fa-solid fa-indian-rupee-sign"></i>{e.new_price}</p>
                            <button className='cartitems-quantity'>{cartItems[e.id]}</button>
                            <p><i class="fa-solid fa-indian-rupee-sign"></i>{e.new_price * cartItems[e.id]} </p>
                ...
                <div className="cartitems-total">
                    ...
                    <div>
                        <div className="cartitems-total-item">
                            <p>Subtotal</p>
                            <p><i class="fa-solid fa-indian-rupee-sign"></i>{getTotalCartAmount()}</p>
                        </div>
                        <hr />
                        <div className="cartitems-total-item">
                            <p>Shipping Fee</p>
                        ...
                        <div className="cartitems-total-item">
                            <h3>Total</h3>
                            <h3><i class="fa-solid fa-indian-rupee-sign"></i>{getTotalCartAmount()}</h3>
                        </div>
                    </div>
